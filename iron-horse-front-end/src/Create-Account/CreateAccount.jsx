  ...
  return (
    <div>
      ...
      >
        ...
        <span>
          A senha deve conter pelo menos 12 caracteres sendo obrigatório ter uma
          letra maiúscula, um número e um símbolo alfanumérico.
        </span>
        ...
        <div className="checkbox-group">
          ...
          <label>
            <input
              ...
              onChange={handleChange}
            />
            Estou devidamente regularizado e sem nenhuma pendência nos órgãos de
            trânsito (DETRAN e DENATRAN).
          </label>
          <label>
            <input
              type="checkbox"
